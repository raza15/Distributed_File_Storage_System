...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post cats_url, params: { cat: { cat: @cat.cat, email: @cat.email, filename: @cat.filename } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { cat: @cat.cat, email: @cat.email, filename: @cat.filename } }
